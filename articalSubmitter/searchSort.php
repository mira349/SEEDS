                                        ...
                                        <tbody>
                                            ...
                                            try {
                                               ...
                                               while ($result = $stmt->fetch(PDO::FETCH_ASSOC)){
                                                   echo '<tr><td>'.$rank.'</td><td>'.$result['author'].'</td><td>'.$result['title'].'</td><td>'.$result['journal'].'</td><td>'.$result['volume'].'</td><td>'.$result['pages'].'</td><td>'.$result['month'].' / '.$result['year'].'</td><td>'.$result['annote'].'</td><td>'.$result['publisher'].'</td></tr>';
                                                    $rank++;
                                                }
                                                if($rank == 1){
